...
#' @return a TSF object
#' @importFrom plyr ddply arrange here mutate
#' @examples
...
gf.liquidity <- function(TS,nwin=21){
  ...
  re <- ddply(re,"stockID",here(mutate),factorscore=zoo::rollapply(TurnoverRate,nwin,sum,fill=NA,align = 'right'))
